...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://whispering-springs-26931.herokuapp.com/'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// Shows all cars.
	var onShowCars = function onShowCars(event) {
	  event.preventDefault();
	  api.showCars().then(ui.showCarsSuccess).catch(ui.showCarsFailure);
	};

	// Delete a car.
	var onSellCar = function onSellCar(event) {
	  event.preventDefault();
	  var id = getFormFields(event.target);
	  api.sellCar(id).then(ui.sellCarSuccess).catch(ui.sellCarFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateCar = function updateCar(carId, data) {
	  return $.ajax({
	...
	// Creates the Ajax function to POST data for new car!
	var showCars = function showCars(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/cars',
	    method: 'GET',
	    headers: {
	...
	// Creates the Ajax function to PATCHES data into a car id!
	var sellCar = function sellCar(carId) {
	  return $.ajax({
	    url: config.apiOrigin + '/cars/' + carId,
	    method: 'DELETE',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var modify = __webpack_require__(33);
	...
	var sellCarSuccess = function sellCarSuccess(id) {
	  $('.delete-banner').show();
	};

	var sellCarFailure = function sellCarFailure(error) {
	  console.error(error);
	};

	var showCarsSuccess = function showCarsSuccess(data) {
	  $('.collection-banner').text('Enter Car Info Below to Add to Collection');
	  ...
	  $('.sell-button').on('click', function (event) {
	    event.preventDefault();
	    var carId = $(event.target).parent().attr('data-id');
	    $(event.target).parent().remove();
	    var api = __webpack_require__(10);
	    api.sellCar(carId).then(sellCarSuccess).catch(sellCarFailure);
	  });
	...
	var showCarsFailure = function showCarsFailure(error) {
	  console.error(error);
	};

	var updateCarSuccess = function updateCarSuccess(data) {};

	var updateCarFailure = function updateCarFailure(error) {
	  console.error(error);
	...
	module.exports = {
	  ...
	  showCarsSuccess: showCarsSuccess,
	  showCarsFailure: showCarsFailure,
	  updateCarSuccess: updateCarSuccess,
	  updateCarFailure: updateCarFailure,
	  sellCarSuccess: sellCarSuccess,
	  sellCarFailure: sellCarFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div data-id='"
	    ...
	    + "' class=\"collection-text\">\n  <h1 style=\"color: white\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"> <small>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.make : stack1), depth0))
	    + " "
	    ...
	    + "</small></h2>\n  <input id=\"mod-button\" class=\"btn-sm btn-primary mod-button\" type=\"button\" name:\"mod-button\" value=\"Modify Car\">\n\n  <!-- Important to Hide/Show -->\n  <div class=\"container col-sm-12 text-center update-area\">\n    <form class=\"mod-car\" class=\"col-sm-12\">\n      <input class=\"text-center form-control col-xs-12\" type=\"text\" name=\"car[color]\" placeholder=\"Enter New Color\">\n      <input class=\"btn-sm btn-success save-button\" type=\"submit\" value=\"Save Changes\">\n    </form>\n    <input class=\"btn-sm btn-warning cancel-button\" type=\"button\" name:\"cancel-button\" value=\"Cancel\">\n  </div>\n\n\n  <input class=\"btn-sm btn-danger sell-button\" type=\"button\" name:\"sell-button\" value=\"Sell Car\">\n  <!-- <button type=\"button\" name=\"button\">Remove</button> -->\n\n</div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.cars : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onUpdateCar = function onUpdateCar(event) {
	  ...
	  var carId = $(this).parent().parent().attr('data-id');
	  api.updateCar(carId, data).then(ui.updateCarSuccess).catch(ui.updateCarFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "36025ac717bce50e75351a6d3289701f.jpg";
